...
my @RandGene = ();
# set genes for the 100000 random genesets, calculate the CC matrix
...
#Write selected random genes into the Rand-$Cycle file 
	my $tmp ="$AllGene-RandomGene100000-$Cycle_Rand";	
...
my $Output2 = "$AllGene-Rand100000-Rand100000-Sum";
my $Output3 = "$AllGene-$InputGene-Rand100000-Sum";
...
{
	my $tmp = "$AllGene-RandomGene100000-$Cycle_Input";
	print F2OUT $tmp . "\t";
